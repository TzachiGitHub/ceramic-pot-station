export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all animate-pulse-whatsapp"
      aria-label="WhatsApp"
    >
